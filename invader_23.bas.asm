...
.L029 ;  if sound  >=  66  &&  sound  <=  97 then sound  =  sound  +  1  :  AUDC0  =  2  :  AUDV0  =  5  :  AUDF0  =  sound  - 67
...
.L065 ;  if shot_x  +  3  >=  inv_x  &&  shot_x  +  3  <=  inv_x  +  6  &&  shot_y  >  inv_y then inv_hit  =  1  :  b{3}  =  0  :  sound  =  0
...
.L081 ;  if joy0fire  &&  u{3} then tur_fired  =  1  :  shot_x  =  tur_x  :  shot_y  =  tur_y  +  1  :  player3x  =  shot_x  :  player3y  =  shot_y
...
.skip48then
.skipL081
.L082 ;  if joy0fire  &&  u{3} then u{3}  =  0  :  sound  =  33
...
.L083 ;  if tur_fired  =  1 then shot_y  =  shot_y  +  2  :  player3x  =  shot_x  :  player3y  =  shot_y
...
.L084 ;  if shot_y  >  77  &&  ! joy0fire then tur_fired  =  0  :  shot_y  =  0  :  player3y  =  shot_y
...
.L086 ;  if inv_shot_x  +  4  >=  tur_x  &&  inv_shot_x  +  2  <=  tur_x  +  6  &&  inv_shot_y  -  5  <  tur_y  - 5 then tur_hit  =  1  :  b{3}  =  0  :  sound  =  66
...
.L088 ;  tur_anim_frame  =  tur_anim_frame  +  1

	INC tur_anim_frame
.
 ; 

.L089 ;  if tur_anim_frame  =  10 then player1:
...
.L090 ;  if tur_anim_frame  =  20 then player1:
...
.L091 ;  if tur_anim_frame  =  30 then player1:
...
.L092 ;  if tur_anim_frame  =  40 then player1:
...
.L093 ;  if tur_anim_frame  =  50 then player1:
...
.L094 ;  if tur_anim_frame  =  60 then player1:
...
.L095 ;  if tur_anim_frame  =  60 then tur_anim_frame  =  0  :  tur_hit  =  0  :  pfscore2  =  pfscore2  /  4  :  tur_x  =  84  :  tur_y  =  14
...
.L0100 ;  player0x  =  0  :  player0y  =  0

	LDA #0
	STA player0x
	STA player0y
.L0101 ;  player1x  =  0  :  player1y  =  0
...
.L0104 ;  player2x  =  85  :  player2y  =  66

	LDA #85
	STA player2x
	LDA #66
	STA player2y
.L0105 ;  player3x  =  85  :  player3y  =  39
