...
PF_data0
	...
	.byte %11101110, %01110101
	if (pfwidth>2)
	.byte %01110101, %01101110
 endif
	.byte %10001010, %00010111
	if (pfwidth>2)
	.byte %01010101, %10100010
 endif
	.byte %10101110, %00110101
	if (pfwidth>2)
	.byte %01010101, %01100110
 endif
	.byte %11101010, %01110101
	if (pfwidth>2)
	.byte %01110010, %10101110
 endif
	.byte %00000000, %00000000
	if (pfwidth>2)
	.byte %00000000, %00000000
