...
; to do: turret explosion - reset in center, life meter?, game over screen, restart, fix autofire, sound
...
main 
 ...
 if _sc3 = $00 then goto game_over
...
col_shot_inv 
 ...
 if inv_blast_delay > 30 then score = score - 1 : inv_hit = 0 : gosub reset_blast 
...
game_over
 ...
 rem player2x = 70 : player2y = 50
 rem  player3x = 78 : player3y = 50
 rem  player4x = 86 : player4y = 50
 rem  player5x = 94 : player5y = 50
 rem 
