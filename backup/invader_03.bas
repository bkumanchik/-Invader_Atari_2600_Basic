...
draw__move_inv_shot
 ...
 if inv_fire_delay = 180 then inv_shot_x = invader_x + 8 : inv_shot_y = invader_y - 9
 if inv_fire_delay = 180 then player2x = inv_shot_x : player2y = inv_shot_y
 if inv_fire_delay = 180 then inv_fire_delay = 0
