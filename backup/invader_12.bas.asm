...
.L04 ;  dim inv_x  =  a  :  a  =  84

	LDA #84
	STA a
.L05 ;  dim inv_y  =  b  :  b  =  76
...
.L011 ;  dim inv_fired  =  l  :  l  =  0
	...
	LDA #0
	STA l
.L012 ;  dim inv_hit  =  n  :  n  =  0

	LDA #0
	STA n
.L013 ;  dim inv_blast_delay  =  o  :  o  =  0
...
.L014 ;  dim tur_x  =  d  :  d  =  84

	LDA #84
	STA d
.L015 ;  dim tur_y  =  e  :  e  =  14

	LDA #14
	STA e
.L016 ;  dim shot_x  =  i  :  i  =  tur_x

	LDA tur_x
	STA i
.L017 ;  dim shot_y  =  j  :  j  =  tur_y

	LDA tur_y
	STA j
.L018 ;  dim tur_fired  =  m  :  m  =  0
...
.L019 ;  gosub draw__move_turret

 jsr .draw__move_turret

.L020 ;  gosub draw__move_turret_shot

 jsr .draw__move_turret_shot

.L021 ;  gosub draw__move_invader

 jsr .draw__move_invader

.L022 ;  gosub draw__move_inv_shot

 jsr .draw__move_inv_shot

.L023 ;  gosub col_shot_inv
...
.L027 ;  if inv_delay  =  15  &&  inv_hit  =  0 then player0:  
...
.L028 ;  if inv_delay  =  30  &&  inv_hit  =  0 then player0:  
...
.L029 ;  if inv_delay  >  30 then inv_delay  =  0
...
.L031 ;  if inv_hit  =  0  &&  inv_dir  =  1  &&  inv_delay  =  15 then inv_x  =  inv_x  +  1
...
.skip5then
.skipL031
.L032 ;  if inv_hit  =  0  &&  inv_dir  =  1  &&  inv_delay  =  30 then inv_x  =  inv_x  +  1
...
.L033 ;  if inv_x  >  143 then inv_dir  =  0  :  inv_x  =  143  :  inv_y  =  inv_y  -  5
...
.L034 ;  if inv_hit  =  0  &&  inv_dir  =  0  &&  inv_delay  =  15 then inv_x  =  inv_x  -  1
...
.skip12then
.skipL034
.L035 ;  if inv_hit  =  0  &&  inv_dir  =  0  &&  inv_delay  =  30 then inv_x  =  inv_x  -  1
...
.L036 ;  if inv_x  <  26 then inv_dir  =  1  :  inv_x  =  26  :  inv_y  =  inv_y  -  5
...
.L037 ;  player0x  =  inv_x  -  8  :  player0y  =  inv_y
...
.L041 ;  inv_fire_delay  =  inv_fire_delay  +  1

	INC inv_fire_delay
.
 ; 

.L042 ;  if inv_fired  =  0  &&  inv_fire_delay  =  180 then inv_shot_x  =  inv_x  :  inv_shot_y  =  inv_y  -  9
...
.skip19then
.skipL042
.L043 ;  if inv_fired  =  0  &&  inv_fire_delay  =  180 then player2x  =  inv_shot_x  :  player2y  =  inv_shot_y
...
.skip21then
.skipL043
.L044 ;  if inv_fired  =  0  &&  inv_fire_delay  =  180 then inv_fired  =  1
...
.L045 ;  if inv_fired  =  1 then inv_shot_y  =  inv_shot_y  -  2  :  player2y  =  inv_shot_y
...
.L046 ;  if inv_shot_y  <  12 then inv_fired  =  0  :  inv_fire_delay  =  0  :  inv_shot_y  =  88  :  player2y  =  inv_shot_y
...
.L048 ;  if shot_x  +  3  >=  inv_x  &&  shot_x  +  3  <=  inv_x  +  6  &&  shot_y  >  inv_y then inv_hit  =  1
...
.L049 ;  if inv_hit  =  1 then inv_blast_delay  =  inv_blast_delay  +  1
...
.L050 ;  if inv_blast_delay  >  30 then score  =  score  +  10  :  inv_hit  =  0  :  gosub reset_blast
...
.L051 ;  if inv_hit  =  1 then player0:  
...
.L054 ;  inv_blast_delay  =  0  :  inv_x  =  84 :  inv_y  =  76
...
.L058 ;  if joy0left  &&  tur_x  >=  26 then tur_x  =  tur_x  -  1
...
.skip33then
.skipL058
.L059 ;  if joy0right  &&  tur_x  <=  143 then tur_x  =  tur_x  +  1
...
.L060 ;  player1x  =  tur_x  :  player1y  =  tur_y
...
.L064 ;  if joy0fire  &&  tur_fired  =  0 then tur_fired  =  1  :  shot_x  =  tur_x  :  shot_y  =  tur_y  +  1  :  player3x  =  shot_x  :  player3y  =  shot_y
...
.L065 ;  if tur_fired  =  1 then shot_y  =  shot_y  +  2  :  player3x  =  shot_x  :  player3y  =  shot_y
...
.L066 ;  if shot_y  >  77 then tur_fired  =  0  :  shot_y  =  0  :  player3y  =  shot_y
