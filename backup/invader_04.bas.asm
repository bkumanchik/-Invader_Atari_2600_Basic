...
.L018 ;  gosub draw__move_invader

 jsr .draw__move_invader

.L019 ;  gosub draw__move_inv_shot
...
.L023 ;  if inv_delay  =  12 then player0:  
...
.L024 ;  if inv_delay  =  24 then player0:  
...
.L025 ;  if inv_delay  >  24 then inv_delay  =  0
...
.L027 ;  if inv_dir  =  1  &&  inv_delay  =  12 then invader_x  =  invader_x  +  1
...
.skip3then
.skipL027
.L028 ;  if inv_dir  =  1  &&  inv_delay  =  24 then invader_x  =  invader_x  +  1
...
.L029 ;  if invader_x  >  135 then inv_dir  =  0  :  invader_x  =  135  :  invader_y  =  invader_y  -  5
...
.L030 ;  if inv_dir  =  0  &&  inv_delay  =  12 then invader_x  =  invader_x  -  1
...
.skip8then
.skipL030
.L031 ;  if inv_dir  =  0  &&  inv_delay  =  24 then invader_x  =  invader_x  -  1
...
.L032 ;  if invader_x  <  18 then inv_dir  =  1  :  invader_x  =  20  :  invader_y  =  invader_y  -  5
...
.L033 ;  player0x  =  invader_x  :  player0y  =  invader_y
...
.L037 ;  inv_fire_delay  =  inv_fire_delay  +  1

	INC inv_fire_delay
.
 ; 

.L038 ;  if inv_fired  =  0  &&  inv_fire_delay  =  180 then inv_shot_x  =  invader_x  +  8  :  inv_shot_y  =  invader_y  -  9
...
.skip13then
.skipL038
.L039 ;  if inv_fired  =  0  &&  inv_fire_delay  =  180 then player2x  =  inv_shot_x  :  player2y  =  inv_shot_y
...
.skip15then
.skipL039
.L040 ;  if inv_fired  =  0  &&  inv_fire_delay  =  180 then inv_fired  =  1
...
.L052 ;  player3x = shot_x : player3y = shot_y
