...
.L038 ;  if inv_fire_delay  =  180 then inv_shot_x  =  invader_x  +  8  :  inv_shot_y  =  invader_y  -  9
...
.condpart13
	...
	STA inv_shot_y
.skipL038
.L039 ;  if inv_fire_delay  =  180 then player2x  =  inv_shot_x  :  player2y  =  inv_shot_y
...
.condpart14
	...
	STA player2y
.skipL039
.L040 ;  if inv_fire_delay  =  180 then inv_fire_delay  =  0
...
.L044 ;  if joy0left  &&  turret_x  >=  26 then turret_x  =  turret_x  -  1
...
.skip16then
.skipL044
.L045 ;  if joy0right  &&  turret_x  <=  143 then turret_x  =  turret_x  +  1
...
.L046 ;  player1x  =  turret_x  :  player1y  =  turret_y
...
.L050 ;  player3x = shot_x : player3y = shot_y
