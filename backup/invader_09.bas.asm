...
.L04 ;  dim invader_x  =  a  :  a  =  68

	LDA #68
	STA a
.L05 ;  dim invader_y  =  b  :  b  =  77
...
.L07 ;  dim inv_dir  =  f  :  f  =  1
	...
	LDA #1
	STA f
.L08 ;  dim inv_shot_x  =  g  :  g  =  76

	LDA #76
	STA g
.L09 ;  dim inv_shot_y  =  h  :  h  =  44
...
.L012 ;  dim turret_x  =  d  :  d  =  76

	LDA #76
	STA d
.L013 ;  dim turret_y  =  e  :  e  =  14

	LDA #14
	STA e
.L014 ;  dim shot_x  =  i  :  i  =  76

	LDA #76
	STA i
.L015 ;  dim shot_y  =  j  :  j  =  turret_y  + 13

	LDA turret_y
	CLC
	ADC #13
	STA j
.L016 ;  dim turret_fired  =  m  :  m  =  0
...
.L024 ;  if inv_delay  =  15 then player0:  
...
.L025 ;  if inv_delay  =  30 then player0:  
...
.L026 ;  if inv_delay  >  30 then inv_delay  =  0
...
.L028 ;  if inv_dir  =  1  &&  inv_delay  =  15 then invader_x  =  invader_x  +  1
...
.skip3then
.skipL028
.L029 ;  if inv_dir  =  1  &&  inv_delay  =  30 then invader_x  =  invader_x  +  1
...
.L030 ;  if invader_x  >  135 then inv_dir  =  0  :  invader_x  =  135  :  invader_y  =  invader_y  -  5
...
.L031 ;  if inv_dir  =  0  &&  inv_delay  =  15 then invader_x  =  invader_x  -  1
...
.skip8then
.skipL031
.L032 ;  if inv_dir  =  0  &&  inv_delay  =  30 then invader_x  =  invader_x  -  1
...
.L033 ;  if invader_x  <  18 then inv_dir  =  1  :  invader_x  =  20  :  invader_y  =  invader_y  -  5
...
.L034 ;  player0x  =  invader_x  :  player0y  =  invader_y
...
.L038 ;  inv_fire_delay  =  inv_fire_delay  +  1

	INC inv_fire_delay
.
 ; 

.L039 ;  if inv_fired  =  0  &&  inv_fire_delay  =  180 then inv_shot_x  =  invader_x  +  8  :  inv_shot_y  =  invader_y  -  9
...
.skip13then
.skipL039
.L040 ;  if inv_fired  =  0  &&  inv_fire_delay  =  180 then player2x  =  inv_shot_x  :  player2y  =  inv_shot_y
...
.skip15then
.skipL040
.L041 ;  if inv_fired  =  0  &&  inv_fire_delay  =  180 then inv_fired  =  1
...
.L042 ;  if inv_fired  =  1 then inv_shot_y  =  inv_shot_y  -  2  :  player2y  =  inv_shot_y
...
.L043 ;  if inv_shot_y  <  12 then inv_fired  =  0  :  inv_fire_delay  =  0  :  inv_shot_y  =  88  :  player2y  =  inv_shot_y
...
.L047 ;  if joy0left  &&  turret_x  >=  26 then turret_x  =  turret_x  -  1
...
.skip21then
.skipL047
.L048 ;  if joy0right  &&  turret_x  <=  143 then turret_x  =  turret_x  +  1
...
.L049 ;  player1x  =  turret_x  :  player1y  =  turret_y
...
.L053 ;  if joy0fire && turret_fired = 0 then turret_fired = 1 : shot_x = turret_x : shot_y = turret_y + 1 : player3x = shot_x : player3y = shot_y
...
.L054 ;  if turret_fired = 1 then shot_y = shot_y + 2 : player3x = shot_x : player3y = shot_y
...
.L055 ;  if shot_y > 77 then turret_fired = 0 :shot_y = 0 :player3y = shot_y 
