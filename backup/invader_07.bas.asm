...
.skip13then
.skipL039
.L040 ;  if inv_fired  =  0  &&  inv_fire_delay  =  180 then player2x  =  inv_shot_x  :  player2y  =  inv_shot_y  :  inv_fired  =  1
...
.L041 ;  if inv_fired  =  1 then inv_shot_y  =  inv_shot_y  -  2  :  player2y  =  inv_shot_y
...
.L042 ;  if inv_shot_y  <  12 then inv_fired  =  0  :  inv_fire_delay  =  0  :  inv_shot_y  =  88  :  player2y  =  inv_shot_y
...
.L046 ;  if joy0left  &&  turret_x  >=  26 then turret_x  =  turret_x  -  1
...
.skip19then
.skipL046
.L047 ;  if joy0right  &&  turret_x  <=  143 then turret_x  =  turret_x  +  1
...
.L052 ;  if joy0fire && turret_fired = 0 then turret_fired = 1 : shot_x = turret_x : shot_y = turret_y + 1 : player3x = shot_x : player3y = shot_y
...
.L053 ;  if turret_fired = 1 then shot_y = shot_y + 2 : player3x = shot_x : player3y = shot_y : score = score + 10
...
.L054 ;  if shot_y > 77 then turret_fired = 0 : shot_y = 0 : player3y = shot_y
