...
.L01 ;  dim invader_x  =  a  :  a  =  76

	LDA #76
	STA a
.L02 ;  dim invader_y  =  b  :  b  =  11

	LDA #11
	STA b
.L03 ;  dim inv_delay  =  c  :  c  =  0

	LDA #0
	STA c
.L04 ;  dim inv_dir  =  f  :  f  =  1
...
.L05 ;  dim turret_x  =  d  :  d  =  76

	LDA #76
	STA d
.L06 ;  dim turret_y  =  e  :  e  =  85
...
.L08 ;  gosub draw__move_turret

 jsr .draw__move_turret

.L09 ;  gosub draw__move_invader
...
.L013 ;  if inv_delay  =  12 then player0:  
...
.L014 ;  if inv_delay  =  24 then player0:  
...
.L015 ;  if inv_delay  >  24 then inv_delay  =  0
...
.L017 ;  if inv_dir  =  1  &&  inv_delay  =  12 then invader_x  =  invader_x  +  1
...
.skip3then
.skipL017
.L018 ;  if inv_dir  =  1  &&  inv_delay  =  24 then invader_x  =  invader_x  +  1
...
.L019 ;  if invader_x  >  135 then inv_dir  =  0  :  invader_x  =  135  :  invader_y  =  invader_y  +  5
...
.L020 ;  if inv_dir  =  0  &&  inv_delay  =  12 then invader_x  =  invader_x  -  1
...
.skip8then
.skipL020
.L021 ;  if inv_dir  =  0  &&  inv_delay  =  24 then invader_x  =  invader_x  -  1
...
.L022 ;  if invader_x  <  20 then inv_dir  =  1  :  invader_x  =  20  :  invader_y  =  invader_y  +  5
...
.L023 ;  player0x  =  invader_x  :  player0y  =  invader_y
...
.L040 ;  rem  player0x = invader_x : player0y = invader_y
...
.L046 ;  if joy0left  &&  turret_x  >  20 then turret_x  =  turret_x  -  1
...
.skip13then
.skipL046
.L047 ;  if joy0right  &&  turret_x  <  135 then turret_x  =  turret_x  +  1
...
.L048 ;  player1x  =  turret_x  :  player1y  =  turret_y
...
.L050 ;  rem  if missile0y > 240 then goto skip

.L051 ;  rem  missile0y = missile0y - 2 : goto draw_loop

.
 ; 

.L052 ;  rem  if joy0fire then missile0y = player0y - 7 : missile0x = player0x + 4
...
.L053 ;  rem if player1y<player0y then player1y = player1y+1

.L054 ;  rem if player1y>player0y then player1y = player1y-1

.L055 ;  rem if player1x<player0x then player1x = player1x+1

.L056 ;  rem if player1x>player0x then player1x = player1x-1

.L057 ;  rem player1x=player1x:player1y=player1y
...
.L058 ;  if collision(missile0,player1) then score  =  score  +  10  :  player1x  =  rand  /  2  :  player1y  =  12  :  missile0y  =  255
...
.condpart17
 ...
 jsr randomize
	...
	STA missile0y
.skipL058
.L059 ;  rem if collision(player0,player1) then score=score-1: player1x=rand/2:player1y=0:missile0y=255
