...
.L010 ;  dim turret_x  =  d  :  d  =  76

	LDA #76
	STA d
.L011 ;  dim turret_y  =  e  :  e  =  14

	LDA #14
	STA e
.L012 ;  dim shot_x  =  i  :  i  =  76

	LDA #76
	STA i
.L013 ;  dim shot_y  =  j  :  j  =  turret_y  + 13
...
.L015 ;  gosub draw__move_turret

 jsr .draw__move_turret

.L016 ;  gosub draw__move_turret_shot

 jsr .draw__move_turret_shot

.L017 ;  gosub draw__move_invader

 jsr .draw__move_invader

.L018 ;  gosub draw__move_inv_shot
...
.L022 ;  if inv_delay  =  12 then player0:  
...
.L023 ;  if inv_delay  =  24 then player0:  
...
.L024 ;  if inv_delay  >  24 then inv_delay  =  0
...
.L026 ;  if inv_dir  =  1  &&  inv_delay  =  12 then invader_x  =  invader_x  +  1
...
.skip3then
.skipL026
.L027 ;  if inv_dir  =  1  &&  inv_delay  =  24 then invader_x  =  invader_x  +  1
...
.L028 ;  if invader_x  >  135 then inv_dir  =  0  :  invader_x  =  135  :  invader_y  =  invader_y  -  5
...
.L029 ;  if inv_dir  =  0  &&  inv_delay  =  12 then invader_x  =  invader_x  -  1
...
.skip8then
.skipL029
.L030 ;  if inv_dir  =  0  &&  inv_delay  =  24 then invader_x  =  invader_x  -  1
...
.L031 ;  if invader_x  <  18 then inv_dir  =  1  :  invader_x  =  20  :  invader_y  =  invader_y  -  5
...
.L032 ;  player0x  =  invader_x  :  player0y  =  invader_y
...
.L036 ;  player2x  =  inv_shot_x  :  player2y  =  inv_shot_y
...
.L040 ;  if joy0left  &&  turret_x  >=  26 then turret_x  =  turret_x  -  1
...
.skip13then
.skipL040
.L041 ;  if joy0right  &&  turret_x  <=  143 then turret_x  =  turret_x  +  1
...
.L042 ;  player1x  =  turret_x  :  player1y  =  turret_y
...
.L046 ;  player3x = shot_x : player3y = shot_y
