...
col_inv_shot_turret
 ...
 if inv_shot_x + 4 >= tur_x  && inv_shot_x + 2 <= tur_x + 6 && inv_shot_y - 5 < tur_y -5 then tur_hit = 1 : goto game_over 

 return



; play turret explode anim 3 times
play_tur_anim 
 ...
 ;if tur_anim_frame = 60 then tur_anim_playing = 0 ; tur_anim_frame = 0
